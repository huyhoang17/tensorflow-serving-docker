...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='protos/tensorflow/core/framework/tensor.proto',
  package='tensorflow',
  syntax='proto3',
  ...
  ,
  dependencies=[protos_dot_tensorflow_dot_core_dot_framework_dot_resource__handle__pb2.DESCRIPTOR,protos_dot_tensorflow_dot_core_dot_framework_dot_tensor__shape__pb2.DESCRIPTOR,protos_dot_tensorflow_dot_core_dot_framework_dot_types__pb2.DESCRIPTOR,])
...
_TENSORPROTO.fields_by_name['dtype'].enum_type = protos_dot_tensorflow_dot_core_dot_framework_dot_types__pb2._DATATYPE
_TENSORPROTO.fields_by_name['tensor_shape'].message_type = protos_dot_tensorflow_dot_core_dot_framework_dot_tensor__shape__pb2._TENSORSHAPEPROTO
_TENSORPROTO.fields_by_name['resource_handle_val'].message_type = protos_dot_tensorflow_dot_core_dot_framework_dot_resource__handle__pb2._RESOURCEHANDLEPROTO
...
TensorProto = _reflection.GeneratedProtocolMessageType('TensorProto', (_message.Message,), dict(
  ...
  __module__ = 'protos.tensorflow.core.framework.tensor_pb2'
