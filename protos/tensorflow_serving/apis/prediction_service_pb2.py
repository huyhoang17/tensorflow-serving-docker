...
def beta_create_PredictionService_server(servicer, pool=None, pool_size=None, default_timeout=None, maximum_timeout=None):
  request_deserializers = {
    ('tensorflow.serving.PredictionService', 'Predict'): protos_dot_tensorflow__serving_dot_apis_dot_predict__pb2.PredictRequest.FromString,
  }
  response_serializers = {
    ('tensorflow.serving.PredictionService', 'Predict'): protos_dot_tensorflow__serving_dot_apis_dot_predict__pb2.PredictResponse.SerializeToString,
  }
...
def beta_create_PredictionService_stub(channel, host=None, metadata_transformer=None, pool=None, pool_size=None):
  request_serializers = {
    ('tensorflow.serving.PredictionService', 'Predict'): protos_dot_tensorflow__serving_dot_apis_dot_predict__pb2.PredictRequest.SerializeToString,
  }
  response_deserializers = {
    ('tensorflow.serving.PredictionService', 'Predict'): protos_dot_tensorflow__serving_dot_apis_dot_predict__pb2.PredictResponse.FromString,
  }
  cardinalities = {
