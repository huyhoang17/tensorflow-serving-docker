...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='protos/tensorflow_serving/apis/predict.proto',
  ...
  ,
  dependencies=[protos_dot_tensorflow_dot_core_dot_framework_dot_tensor__pb2.DESCRIPTOR,protos_dot_tensorflow__serving_dot_apis_dot_model__pb2.DESCRIPTOR,])
...
_PREDICTREQUEST_INPUTSENTRY.fields_by_name['value'].message_type = protos_dot_tensorflow_dot_core_dot_framework_dot_tensor__pb2._TENSORPROTO
_PREDICTREQUEST_INPUTSENTRY.containing_type = _PREDICTREQUEST
_PREDICTREQUEST.fields_by_name['model_spec'].message_type = protos_dot_tensorflow__serving_dot_apis_dot_model__pb2._MODELSPEC
_PREDICTREQUEST.fields_by_name['inputs'].message_type = _PREDICTREQUEST_INPUTSENTRY
_PREDICTRESPONSE_OUTPUTSENTRY.fields_by_name['value'].message_type = protos_dot_tensorflow_dot_core_dot_framework_dot_tensor__pb2._TENSORPROTO
_PREDICTRESPONSE_OUTPUTSENTRY.containing_type = _PREDICTRESPONSE
_PREDICTRESPONSE.fields_by_name['model_spec'].message_type = protos_dot_tensorflow__serving_dot_apis_dot_model__pb2._MODELSPEC
...
PredictRequest = _reflection.GeneratedProtocolMessageType('PredictRequest', (_message.Message,), dict(
  ...
  InputsEntry = _reflection.GeneratedProtocolMessageType('InputsEntry', (_message.Message,), dict(
    ...
    __module__ = 'protos.tensorflow_serving.apis.predict_pb2'
